        ...
        <div class="right">
            ...
            <table class="layui-table layui-form">
                ...
                <tr class="id84">
                    ...
                    <td style="font-size: 15px">${h.appointmentName}</td>
                    <td style="width: 17%">
                    ...
                    <a href="${pageContext.request.contextPath}/home/show?id=${h.id}">详细信息</a>
                        ...
                        <a href="${pageContext.request.contextPath}/admin/auditHomeAppointment?id=${h.id}&type=0">通过</a>&nbsp;&nbsp;|&nbsp;&nbsp;
                        <a href="${pageContext.request.contextPath}/admin/auditHomeAppointment?id=${h.id}&type=1">拒绝</a>
                    </td>
                </tr>
                </c:forEach>
                </tbody>
